...
public interface TaskRepository extends JpaRepository<Task,Long> {
    ...
    @Query("SELECT new com.plannerapp.model.binding.AllAvailableTasksBindingModel(t.id,t.description,t.dueDate,t.priority.name) FROM Task t WHERE t.user.id = null ")
